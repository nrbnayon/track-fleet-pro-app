...
import { ArrowLeft, Plus, FileText, Trash2 } from 'lucide-react-native';
        ...
        <ScrollView contentContainerStyle={{ paddingHorizontal: 20, paddingBottom: 20 }}>
            {documents.length === 0 ? (
                ...
                <View className="gap-4">
                    {documents.map((doc) => (
                        <View key={doc.id} className="flex-row items-center bg-white p-4 rounded-sm shadow-[4px_4px_10px_0_rgba(0,0,0,0.08)]">
